...
import { PromoBanner } from '@/components/appliances/PromoBanner';
...
import { AllServicesPage } from '@/components/appliances/AllServicesPage';
...
import { PaymentFailureModal } from '@/components/app/components/ui/PaymentFailureModal';
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      <PaymentFailureModal
        ...
        onChangeMethod={handleRetryPayment}
