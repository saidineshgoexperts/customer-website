                            ...
                            >
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <a
                                        ...
                                        className="flex items-center gap-3 px-8 py-4 rounded-xl bg-gradient-to-r from-[#037166] to-[#04a99d] text-white font-bold hover:shadow-lg hover:shadow-[#037166]/30 transition-all transform hover:-translate-y-1"
                                    >
