...
export function ServiceBookingModal({ isOpen, onClose }) {
    ...
    const handleCategorySelect = async (category) => {
        ...
        try {
            ...
            if (data.success && data.data) {
                ...
                router.push(`/services/category/${category._id}?name=${encodeURIComponent(category.name)}`);
                onClose();
            }
        } catch (error) {
    ...
    const handleSubCategorySelect = (subCategory) => {
        ...
        router.push(`/services/listing/${subCategory._id}?category=${encodeURIComponent(selectedCategory.name)}&name=${encodeURIComponent(subCategory.name)}`);
        onClose();
    };
